...
const leftExpression = convertSimpleFractions(sides[0]);
const rightExpression = convertSimpleFractions(sides[1]);

const left = parsePolynomial(leftExpression);
const right = parsePolynomial(rightExpression);
