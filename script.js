document.addEventListener("DOMContentLoaded", function () {
    ...
    function divide(a, b) {
        ...
        if (
            ...
            throw new Error(
                "در این نسخه، تقسیم بر عبارت متغیر پشتیبانی نمی‌شود."
            );
        }
    ...
    function showResult(result) {
        ...
        if (result.type === "linear") {
            ...
            stepsBox.innerHTML =
                ...
                "<div class='step-line'>" +
                "عدد ثابت را به طرف دیگر می‌بریم." +
                "</div>" +
        ...
        if (result.type === "infinite") {
            ...
            stepsBox.innerHTML =
                "<div class='step-line'>" +
                "دو طرف معادله پس از ساده‌سازی یکسان هستند." +
                "</div>" +

                "<div class='step-line'>" +
                "بنابراین معادله بی‌نهایت جواب دارد." +
                "</div>";
        ...
        stepsBox.innerHTML =
            "<div class='step-line'>" +
            "دو طرف معادله پس از ساده‌سازی برابر نیستند." +
            "</div>" +
